...
def gate_knock(b=None):
    """Daily consent knock on a held door. Releases exactly ONE thing: his own
    handoff note — written by him, for the moment of deciding to return — and
    only while the door is held. Not a visit; nothing else leaves the seal."""
    a = _j(os.path.join(ROOT, "active.json"), {})
