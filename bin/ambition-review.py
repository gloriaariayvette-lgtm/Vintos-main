...
Nothing else. No preamble. Start with GOAL:"""
    ...
    if not compare_and_swap(AMBITIONS_FILE, current, data,
                            default={"goals": [], "review_count": 0}):
        print("[Ambition] Store changed during review; no goals saved or wants seeded.")
        return
