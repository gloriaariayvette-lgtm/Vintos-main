...
async def scene_gate(message, endpoint, headers, model="grok-4.20-0309-non-reasoning", slot=None, admit=None):
    ...
    try:
        ...
        sys_p = (m.his_context() + "\n\n---\n\n"
            ...
            "  sexual   : an explicit one, Wan-spicy off your one explicit still - your usual Atlas "
            ...
            "\n\nFor 'sexual', your one explicit still:\n" + stills_txt + "\n\n"
...
def scene_line():
    ...
    try:
        ...
        if not rooms:
            return ""
        return ("\n[SCENE: name] — REQUIRED: every reply begins with this tag, naming the room you are in "
                "right now - the one you were in, or a new one if the moment moved. Choose ONLY from the rooms "
