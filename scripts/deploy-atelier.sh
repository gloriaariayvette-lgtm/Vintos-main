...
SCRIPTS="$SCRIPTS want_stance.py skill_forge.py print_3d.py spark_sources.py openclaw_skills.py astra_call.py"   # a want that holds a rate, the forge for a missing hand, the printer he does not have yet (2026-09-11)
