...
SCRIPTS="$SCRIPTS chemistry_probe.py chemistry_instrument_probe.py chemistry_mcp.py"   # Lab instrument receipts and bounded protein-design MCP route
