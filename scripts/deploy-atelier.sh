...
SCRIPTS="$SCRIPTS lab_http.py lab_sources.py lab_atlas_worker.py chemistry_sources.py chemistry_genomic.py forge_loop.py forge_loop_runtime.py forge_loop_atelier.py forge_loop_ntfy.py plugin_catalog.py plugin_gateway.py plugin_relay_remote.py atelier_plugin.py"
...
SCRIPTS="$SCRIPTS calibration.py jepa_calibration_audit.py jepa_ranking_audit.py idempotency.py"   # JEPA calibration plus true-next ranking control
...
SCRIPTS="$SCRIPTS context_selection.py isolated_exec.py run_isolated_test.py test_http_fixture.py want_stance.py skill_forge.py forge_build.py forge_resume.py print_3d.py spark_sources.py forge_want_context.py forge_house.py openclaw_skills.py astra_call.py"   # a want that holds a rate, the forge for a missing hand, the builder that fills it, the resume that hands it back to the want, the printer he does not have yet (2026-09-11)
