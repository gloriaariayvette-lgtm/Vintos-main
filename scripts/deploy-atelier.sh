...
SCRIPTS="$SCRIPTS desktop_agent.py desktop_windows.py desktop_winpy.py screen_share.py browser_winpy.py browser_agent.py browser_jev.py"   # his hands, eyes and browser on the Windows desktop; Jev is the bounded fast browser chooser (2026-09-18)
