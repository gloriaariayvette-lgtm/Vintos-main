...
BINS="robot-pi-repoint.sh purge-test-residue.py resonance-rescore.py systems-checkup.py music-share.py music-composer.py server.py model_router.py merged_full_route.py humor_detector.py humor_reaction.py
