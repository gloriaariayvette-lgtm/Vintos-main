...
SCRIPTS="$SCRIPTS tension_ledger.py commitment_spine.py drift_reason.py opposition_calibration.py opposition_misuse.py"  # migrated shared-store writers, 2026-09-11
