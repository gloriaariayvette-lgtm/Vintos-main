...
_WAL_FACTS=$(grep -E '^- \[' "$MEMORY/wal.md" 2>/dev/null | grep -F '**' | tail -24)
if [ -n "$_WAL_FACTS" ]; then
AUTO_WAL="Persistent facts you know about Gloria (true and current):
$_WAL_FACTS
...
What I haven't said yet matters more than what I've already named. I go there."""
    ...
    audit1_r = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": "Bearer " + __import__("os").environ.get("XAI_API_KEY",""), "Content-Type": "application/json"}, json={
        "model": "grok-4.20-0309-non-reasoning",
    ...
    audit_r = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": "Bearer " + __import__("os").environ.get("XAI_API_KEY",""), "Content-Type": "application/json"}, json={
        "model": "grok-4.20-0309-non-reasoning",
    ...
    r3 = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": f"Bearer {os.environ.get('XAI_API_KEY','')}", "Content-Type": "application/json"}, json={
        "model": "grok-4.20-0309-non-reasoning",
        "messages": [
    ...
    try:
        ...
        if not _ag_pass and _raw:
            ...
            r3b = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": "Bearer " + __import__("os").environ.get("XAI_API_KEY",""), "Content-Type": "application/json"}, json={
                "model": "grok-4.20-0309-non-reasoning",
                "messages": [
    ...
    if _overlap < 6 and _raw:
        ...
        _rv = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": f"Bearer {os.environ.get('XAI_API_KEY','')}", "Content-Type": "application/json"}, json={
            "model": "grok-4.20-0309-non-reasoning",
    ...
    audit2_r = requests.post("http://127.0.0.1:8599/v1/chat/completions", headers={"Authorization": "Bearer " + __import__("os").environ.get("XAI_API_KEY",""), "Content-Type": "application/json"}, json={
        "model": "grok-4.20-0309-non-reasoning",
